...
![Host & Property](page2.png)

📑 [View the Executive Summary Presentation (PDF)](Airbnb_Executive_Summary.pdf) — a 7-slide business summary of the key findings below.
...
### 6\. Revenue growth reversed in 2025

Year-over-year revenue grew from $56.92M (2023) to $57.76M (2024), then **dropped to $56.50M in 2025 (−2.2% YoY)** — alongside a slight dip in Avg Nightly Rate (−0.8%) and the largest jump in the cancellation-policy indicator (+1.4%) of any year tracked.

**Insight:** The dashboard's headline "+47.4% YoY" revenue figure is a cumulative/blended number that masks a real reversal in the most recent year — growth did not continue uninterrupted.
**Recommendation:** Investigate what changed in 2025 specifically (pricing, demand, competition, or inventory mix) before assuming the overall growth trend will continue into 2026.

### 7\. Room type determines which booking channel performs best

Filtering by room type reveals a different top booking channel for each segment: **Hotel room** bookings lean Corporate, **Entire home/apt** leans Web, **Private room** leans Airbnb App, and **Shared room** leans Partner. No single channel holds the #1 spot across all room types — or even across all years.

**Insight:** Booking channel performance is not uniform across the business; a channel that works well for one room type may underperform for another.
**Recommendation:** Match marketing/acquisition spend by channel to the room type it actually performs best for, rather than applying a single channel strategy platform-wide.
